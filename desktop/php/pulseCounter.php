   ...
   <!-- *************************************** -->
							...
							<div id="div_advancedParams" style="overflow-x: hidden; display: none;">                                           
								...
								<div class="form-group">
									...
									<div class="col-xs-11 col-sm-7">
										<a class="btn btn-default btn-sm" id="bt_HistlValue"><i class="fas fa-plus-circle"></i> {{Renseigner}}</a>
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-xs-11 col-sm-7">
                                      <a class="btn btn-default btn-sm" id="bt_accessUrls"><i class="fas fa-plus-circle"></i> {{Push-urls}}</a>
                                ...
                                <div class="form-group">
									<label class="col-sm-4 control-label">{{Synchroniser les commandes}}
										<sup><i class="fas fa-question-circle" title="N'utililiser qu'en cas de besoin absolue"></i></sup>
                                    </label>
									<div class="col-xs-11 col-sm-7">
										<a class="btn btn-danger btn-sm" id="bt_SyncCmds"><i class="fas fa-plus-circle"></i> {{Renseigner}}</a>
									</div>
								</div>
							</div><!--  advancedParams  -->   
